# Generated by Django 3.2.25 on 2024-03-31 15:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tech_security_items', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['day'],
            },
